...
def main():
    ...
    parser.add_option("--method", dest="chooser_module",
                      ...
                      type="string", default="GPEIOptChooser2")
...
def run():
    ...
    for i in range(0,loops):
       ...
       if i<num_trials:
            ...
            queue= main_controller({'config_file': 'config.json', 'grid_size':20000,'max_finished_jobs':1000,'chooser_args':"", 'results_file': 'results.dat', 'num_jobs': num_points, 'chooser_module': 'GPEIOptChooser2', 'grid_seed': 1},[''])
